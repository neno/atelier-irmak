    ...
    <ContainerVertical className='py-16'>
      <Container className="text-center max-w-3xl">
        ...
        <p className="mt-4">
          ...
          aufgerufen haben. Wir bitten Sie, diese noch einmal zu überprüfen.
          Es ist auch möglich, dass wir die betreffende Seite verschoben,
          archiviert oder umbenannt haben.
        </p>
        <Button className="inline-block py-2 font-medium mt-12" path="/">Zur Startseite</Button>
      </Container>
    </ContainerVertical>
  )
}