...
export const Nav: FC<NavProps> = ({ items }) => {
  ...
  return (
    ...
    >
      <Container>
        <nav
          className={clsxm('lg:h-auto lg:flex items-center')}
        >
          <div className='flex items-center'>
            ...
            <div className="flex gap-4 md:gap-6 ml-auto lg:hidden">
              <a aria-label="Rufen Sie uns an" className="hover:text-primary-light" href="tel:+41313120604"><Icon iconName={IconType.Phone} width={36} height={36} className='md:h-12 md:w-12' /></a>
              <a aria-label="Kontaktieren Sie uns via E-Mail" className="hover:text-primary-light" href="mailto:info@atelier-irmak.ch"><Icon iconName={IconType.Email} width={36} height={36} className='md:h-12 md:w-12' /></a>
            </div>
            <button
          ...
          <div className="gap-4 ml-8 hidden lg:flex">
            <a className="hover:text-primary-light" href="tel:+41313120604"><Icon iconName={IconType.Phone} width={36} height={36} /></a>
            <a className="hover:text-primary-light" href="mailto:info@atelier-irmak.ch"><Icon iconName={IconType.Email} width={36} height={36} /></a>
          </div>
        </nav>
      </Container>
    </div>
